...
- 可搜索节点、按最小边权筛选、调节统一的节点距离标尺、缩放、平移与拖动节点。
...
顶部的“力平衡”滑块范围为 0–200，默认 100。向左为“松散”：斥力增强、边约束变柔；向右为“紧密”：引力与边约束增强、节点聚拢。它会协同控制 CoSE 与 d3-force 的距离尺度、斥力、中心吸引和边刚性，而不是进行简单的等比例缩放。
